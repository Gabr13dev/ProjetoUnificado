...
public class ViewJTable extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        p.setNome(txtQtd.getText());
        p.setUsuarioDono(Integer.parseInt(txtPreco.getText()));
        dao.create(p);
...
//        System.out.println("Linha selecionada: "+jTProjetos.getSelectedRow());
    ...
    private void jTProjetosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTProjetosMouseClicked
        ...
        if (jTProjetos.getSelectedRow() != -1) {
            ...
            txtDesc.setText(jTProjetos.getValueAt(jTProjetos.getSelectedRow(), 1).toString());
            txtQtd.setText(jTProjetos.getValueAt(jTProjetos.getSelectedRow(), 2).toString());
            txtPreco.setText(jTProjetos.getValueAt(jTProjetos.getSelectedRow(), 3).toString());
